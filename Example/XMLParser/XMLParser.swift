        ...
        if !string.hasSuffix("]") {
            ...
            if let r1 = string.range(of: "["), string[..<r1.lowerBound] == name{
                if let r2 = string.range(of: "="){
                    return attributes[string[r1.upperBound..<r2.lowerBound]] == string[r2.upperBound..<string.index(before: string.endIndex)]
                }else{
                    return attributes[string[r1.upperBound..<string.index(before: string.endIndex)]] != nil
                }
            }else{
                return false
            }
